                 ...
                 <form action="" method="post">
                    ...
                    <table class="form">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" readonly value="<?php echo $result['fname'].' '.$result['lname']; ?>" class="medium" />
                            </td>
                        </tr>                        
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="tinymce" name="message"><?php echo $result['message'];?></textarea>
                            </td>
                        </tr>
